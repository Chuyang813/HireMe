  ...
  return (
    <div ref={wrapperRef} className="relative">
      <button
        ...
        className="inline-flex h-10 items-center gap-2 rounded-lg px-2 text-sm font-medium text-muted-foreground transition duration-150 ease-out hover:bg-muted hover:text-foreground active:scale-[0.97]"
      >
      ...
      {open && (
        <div
          role="menu"
          className="popover-enter absolute right-0 top-[calc(100%+0.375rem)] z-30 w-56 overflow-hidden rounded-xl border border-border bg-background shadow-[var(--shadow-float)]"
        >
